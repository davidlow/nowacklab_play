...
# Function to create the base plot, make sure to make global the lines, 
# axes, canvas and any part that you would want to update later
def plot():    
    ...
    try:       #Try to check if there is data in the queue
        ...
        if result !='Q':
             print(result)
                 ...
                 # the global variables that you defined in the plot 
                 # function, and have the data that the simulation sent.
